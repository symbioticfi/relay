...
//
//	mockgen -source=eth.go -destination=mocks/eth.go -package=mocks
//
...
func (m *Mockmetadata) GetAbi() (*abi.ABI, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAbi")
...
func (mr *MockmetadataMockRecorder) GetAbi() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAbi", reflect.TypeOf((*Mockmetadata)(nil).GetAbi))
}
