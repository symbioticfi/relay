...
func addRootFlags(cmd *cobra.Command) {
	...
	rootCmd.PersistentFlags().Int64("badger.block-cache-size", 33554432, "BadgerDB block cache size in bytes, 0 = disabled")
	rootCmd.PersistentFlags().Int64("badger.mem-table-size", 16777216, "BadgerDB memtable size in bytes")
	rootCmd.PersistentFlags().Int("badger.num-memtables", 2, "BadgerDB number of memtables")
	rootCmd.PersistentFlags().Int("badger.num-level-zero-tables", 2, "BadgerDB L0 tables before compaction triggers")
	rootCmd.PersistentFlags().Int("badger.num-level-zero-tables-stall", 4, "BadgerDB L0 tables before writes stall")
	rootCmd.PersistentFlags().Bool("badger.compact-l0-on-close", true, "BadgerDB compact L0 on graceful shutdown")
	rootCmd.PersistentFlags().Int("badger.num-compactors", 4, "BadgerDB concurrent compaction goroutines")
