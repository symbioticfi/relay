...
func addRootFlags(cmd *cobra.Command) {
	...
	rootCmd.PersistentFlags().Duration("pruner.interval", time.Minute, "How often to run a pruning tick")
	rootCmd.PersistentFlags().Int("pruner.batch-size", 1000, "Number of request IDs to process per pruning tick (0 = unbatched)")
