...
// GetKeyAt is a free data retrieval call binding the contract method 0xa1a43ec9.
//
// Solidity: function getKeyAt(address operator, uint8 tag, uint48 timestamp, bytes hint) view returns(bytes)
func (_IKeyRegistry *IKeyRegistryCaller) GetKeyAt(opts *bind.CallOpts, operator common.Address, tag uint8, timestamp *big.Int, hint []byte) ([]byte, error) {
	var out []interface{}
	err := _IKeyRegistry.contract.Call(opts, &out, "getKeyAt", operator, tag, timestamp, hint)
...
//
// Solidity: function getKeyAt(address operator, uint8 tag, uint48 timestamp, bytes hint) view returns(bytes)
func (_IKeyRegistry *IKeyRegistrySession) GetKeyAt(operator common.Address, tag uint8, timestamp *big.Int, hint []byte) ([]byte, error) {
	return _IKeyRegistry.Contract.GetKeyAt(&_IKeyRegistry.CallOpts, operator, tag, timestamp, hint)
}

// GetKeyAt is a free data retrieval call binding the contract method 0xa1a43ec9.
//
// Solidity: function getKeyAt(address operator, uint8 tag, uint48 timestamp, bytes hint) view returns(bytes)
func (_IKeyRegistry *IKeyRegistryCallerSession) GetKeyAt(operator common.Address, tag uint8, timestamp *big.Int, hint []byte) ([]byte, error) {
	return _IKeyRegistry.Contract.GetKeyAt(&_IKeyRegistry.CallOpts, operator, tag, timestamp, hint)
}
...
// GetKeysAt0 is a free data retrieval call binding the contract method 0xd48fe71c.
//
// Solidity: function getKeysAt(address operator, uint48 timestamp, bytes hints) view returns((uint8,bytes)[] keys)
func (_IKeyRegistry *IKeyRegistryCaller) GetKeysAt0(opts *bind.CallOpts, operator common.Address, timestamp *big.Int, hints []byte) ([]IKeyRegistryKey, error) {
	var out []interface{}
	err := _IKeyRegistry.contract.Call(opts, &out, "getKeysAt0", operator, timestamp, hints)
...
//
// Solidity: function getKeysAt(address operator, uint48 timestamp, bytes hints) view returns((uint8,bytes)[] keys)
func (_IKeyRegistry *IKeyRegistrySession) GetKeysAt0(operator common.Address, timestamp *big.Int, hints []byte) ([]IKeyRegistryKey, error) {
	return _IKeyRegistry.Contract.GetKeysAt0(&_IKeyRegistry.CallOpts, operator, timestamp, hints)
}

// GetKeysAt0 is a free data retrieval call binding the contract method 0xd48fe71c.
//
// Solidity: function getKeysAt(address operator, uint48 timestamp, bytes hints) view returns((uint8,bytes)[] keys)
func (_IKeyRegistry *IKeyRegistryCallerSession) GetKeysAt0(operator common.Address, timestamp *big.Int, hints []byte) ([]IKeyRegistryKey, error) {
	return _IKeyRegistry.Contract.GetKeysAt0(&_IKeyRegistry.CallOpts, operator, timestamp, hints)
}
